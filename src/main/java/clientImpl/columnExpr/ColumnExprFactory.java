...
public class ColumnExprFactory {
    ...
    public static @NotNull InputValue valueWithAlias(@Nullable Object value,
    ...
    public static @NotNull SumColumnExpression sumWithAlias(
    ...
    public static @NotNull SumColumnExpression sumWithAlias(@NotNull String tableName,
                                                            @NotNull String columnName,
                                                            @NotNull ColumnExpression rightOperand,
                                                            @NotNull String alias) {
    ...
    public static @NotNull SumColumnExpression sumWithAlias(@NotNull String tableName1,
                                                            @NotNull String columnName1,
                                                            @NotNull String tableName2,
                                                            @NotNull String columnName2,
                                                            @NotNull String alias) {
        return sumWithAlias(columnRef(tableName1, columnName1),
                columnRef(tableName2, columnName2), alias);
    }
    ...
    public static @NotNull SumColumnExpression sum(@NotNull String tableName1,
                                                   ...
                                                   @NotNull String tableName2,
                                                   @NotNull String columnName2) {
        return sum(columnRef(tableName1, columnName1),
                columnRef(tableName2, columnName2));
    }

    // *************************** DiffColumnExpression **********************************

    public static @NotNull DiffColumnExpression diffWithAlias(
            @NotNull ColumnExpression leftOperand,
            @NotNull ColumnExpression rightOperand,
            @NotNull String alias) {
    ...
    public static @NotNull DiffColumnExpression diffWithAlias(@NotNull String tableName,
                                                              @NotNull String columnName,
                                                              @NotNull ColumnExpression rightOperand,
                                                              @NotNull String alias) {
    ...
    public static @NotNull DiffColumnExpression diffWithAlias(@NotNull String tableName1,
                                                              @NotNull String columnName1,
                                                              @NotNull String tableName2,
                                                              @NotNull String columnName2,
                                                              @NotNull String alias) {
        return diffWithAlias(columnRef(tableName1, columnName1),
                columnRef(tableName2, columnName2), alias);
    }

    public static @NotNull DiffColumnExpression diff(
            @NotNull ColumnExpression leftOperand,
            @NotNull ColumnExpression rightOperand) {
    ...
    public static @NotNull DiffColumnExpression diff(@NotNull String tableName1,
                                                     ...
                                                     @NotNull String tableName2,
                                                     @NotNull String columnName2) {
        return diff(columnRef(tableName1, columnName1),
                columnRef(tableName2, columnName2));
    }
    ...
    public static @NotNull ProductColumnExpression productWithAlias(
            @NotNull ColumnExpression leftOperand,
            @NotNull ColumnExpression rightOperand,
            @NotNull String alias) {
    ...
    public static @NotNull ProductColumnExpression productWithAlias(
            @NotNull String tableName1, @NotNull String columnName1,
            @NotNull String tableName2, @NotNull String columnName2,
            @NotNull String alias) {
        return productWithAlias(columnRef(tableName1, columnName1),
                columnRef(tableName2, columnName2), alias);
    }

    public static @NotNull ProductColumnExpression product(
            @NotNull ColumnExpression leftOperand,
            @NotNull ColumnExpression rightOperand) {
    ...
    public static @NotNull ProductColumnExpression product(@NotNull String tableName1,
                                                           ...
                                                           @NotNull String tableName2,
                                                           @NotNull String columnName2) {
        return product(columnRef(tableName1, columnName1),
                columnRef(tableName2, columnName2));
    }
    ...
    public static @NotNull DivisionColumnExpression divisionWithAlias(
            @NotNull ColumnExpression leftOperand,
            @NotNull ColumnExpression rightOperand,
            @NotNull String alias) {
    ...
    public static @NotNull DivisionColumnExpression divisionWithAlias(
            ...
            @NotNull String tableName2, @NotNull String columnName2,
            @NotNull String alias) {
        return divisionWithAlias(columnRef(tableName1, columnName1),
                columnRef(tableName2, columnName2), alias);
    }

    public static @NotNull DivisionColumnExpression division(
            @NotNull ColumnExpression leftOperand,
            @NotNull ColumnExpression rightOperand) {
    ...
    public static @NotNull DivisionColumnExpression division(@NotNull String tableName1,
                                                             ...
                                                             @NotNull String tableName2,
                                                             @NotNull String columnName2) {
        return division(columnRef(tableName1, columnName1),
                columnRef(tableName2, columnName2));
    }

    // *************************** CountAggregateFunction **********************************

    public static @NotNull CountAggregateFunction countWithAlias(
            @NotNull ColumnRef columnRef, @NotNull String alias) {
    ...
    public static @NotNull CountAggregateFunction countAllWithAlias(
            @NotNull String alias) {
    ...
    public static @NotNull CountAggregateFunction count(@NotNull String tableName,
                                                        @NotNull String columnName) {
    ...
    public static @NotNull SumAggregateFunction groupSumWithAlias(
            @NotNull ColumnRef columnRef, @NotNull String alias) {
    ...
    public static @NotNull SumAggregateFunction groupSum(@NotNull String tableName,
                                                         @NotNull String columnName) {
    ...
    public static @NotNull MaxAggregateFunction maxWithAlias(@NotNull ColumnRef columnRef,
                                                             @NotNull String alias) {
        return new MaxAggregateFunctionImpl(columnRef, alias);
    }

    public static @NotNull MaxAggregateFunction maxWithAlias(@NotNull String tableName,
                                                             @NotNull String columnName,
                                                             @NotNull String alias) {
        return maxWithAlias(columnRef(tableName, columnName), alias);
    }

    public static @NotNull MaxAggregateFunction maxWithAlias(@NotNull String columnName,
                                                             @NotNull String alias) {
    ...
    public static @NotNull MaxAggregateFunction max(@NotNull String tableName,
                                                    @NotNull String columnName) {
    ...
    public static @NotNull MinAggregateFunction minWithAlias(@NotNull ColumnRef columnRef,
                                                             @NotNull String alias) {
        return new MinAggregateFunctionImpl(columnRef, alias);
    }

    public static @NotNull MinAggregateFunction minWithAlias(@NotNull String tableName,
                                                             @NotNull String columnName,
                                                             @NotNull String alias) {
        return minWithAlias(columnRef(tableName, columnName), alias);
    }

    public static @NotNull MinAggregateFunction minWithAlias(@NotNull String columnName,
                                                             @NotNull String alias) {
    ...
    public static @NotNull MinAggregateFunction min(@NotNull String tableName,
                                                    @NotNull String columnName) {
    ...
    public static @NotNull AvgAggregateFunction avgWithAlias(@NotNull ColumnRef columnRef,
                                                             @NotNull String alias) {
        return new AvgAggregateFunctionImpl(columnRef, alias);
    }

    public static @NotNull AvgAggregateFunction avgWithAlias(@NotNull String tableName,
                                                             @NotNull String columnName,
                                                             @NotNull String alias) {
        return avgWithAlias(columnRef(tableName, columnName), alias);
    }

    public static @NotNull AvgAggregateFunction avgWithAlias(@NotNull String columnName,
                                                             @NotNull String alias) {
    ...
    public static @NotNull AvgAggregateFunction avg(@NotNull String tableName,
                                                    @NotNull String columnName) {
